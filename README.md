...
- Note: In a production version, QR codes would be hidden under scratch-off coatings for security. This MVP omits some restrictions for demo purposes. Also updated ui design for user app( new feature added too) and ui design for admin v2 are all available in the repo, sites too available.
...
4. **Backend Integration:** A Node.js + Express API connects to Hedera.  
